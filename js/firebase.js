...
$('.mar-bottom').html(' <div class="title">                        <h3>Get In Contact</h3>                    </div>                    <ul class="footer-contact-info">                        <li>                            <div class="icon-holder">                                <span class="flaticon-maps-and-flags"></span>                            </div>                            <div class="text-holder">                                <h5>'+data.location+'</h5>                            </div></li>                        <li>                            <div class="icon-holder">                                <span class="flaticon-phone-receiver"></span>                            </div>                            <div class="text-holder">                                <h5>Phone '+data.phone+'</h5>                            </div>                        </li>                        <li>                            <div class="icon-holder">                                <span class="flaticon-envelope"></span> </div> <div class="text-holder"><h5>'+data.email+'</h5></div></li><li><div class="icon-holder"><span class="fa fa-whatsapp"></span></div><div class="text-holder"><h5>'+data.phone+'</h5></div></li></ul><div class="map"><a href="https://g.page/Arrowcentre-tyres-kampala?share">Find Us On Map</a></div>');  
});
}
